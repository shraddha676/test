...
const PRODUCTS = [
  {
    ...
    rating: 4.6,
    reviews: 218,
    image: "https://m.media-amazon.com/images/I/91Et9PposwL._SY879_.jpg?w=400&h=300&fit=crop&q=80",
    description: "Standard blue dry-waste bin with lid. Ideal for paper, plastic, glass, and metal recyclables.",
    badge: "Best Seller",
    badgeColor: "bg-amber-100 text-amber-800",
    buyLink: "https://www.amazon.in/s?k=blue+dry+waste+bin+with+lid",
  },
  {
    id: 2,
    name: "Bin (Wet Waste)",
    ...
    rating: 4.4,
    reviews: 143,
    image: "https://m.media-amazon.com/images/I/31d08uoAXzL._SX342_SY445_QL70_FMwebp_.jpg?w=400&h=300&fit=crop&q=80",
    badge: null,
    description: "Green 10L wet-waste bin with secure lid. Odour-sealed for food scraps and organic waste.",
    badgeColor: "",
    buyLink: "https://www.amazon.in/s?k=green+wet+waste+bin+organic",
  },
  {
    id: 3,
    ...
    description: "Set of 5 colour-coded bins with lids for complete waste segregation at home or office.",
    badge: "New",
    badgeColor: "bg-blue-100 text-blue-800",
    buyLink: "https://www.amazon.in/s?k=color+coded+waste+segregation+bin+set+5+piece",
  },
  {
    id: 4,
    ...
    rating: 4.9,
    reviews: 203,
    image: "https://images.unsplash.com/photo-1595074475099-d59a18699c6c?w=400&h=300&fit=crop&q=80",
    description: "Organic Composter Kit — odour-locked home compost unit for vegetable peels and food scraps. Converts waste to manure in 45 days.",
    badge: "Top Rated",
    badgeColor: "bg-green-100 text-green-800",
    buyLink: "https://www.amazon.in/s?k=organic+composter+kit+home",
  },
  {
    id: 5,
    ...
    description: "Large garden-specific outdoor composter with aeration system for rich organic soil.",
    badge: null,
    badgeColor: "",
    buyLink: "https://www.amazon.in/s?k=garden+compost+bin+80+litre+outdoor",
  },
  {
    id: 6,
    ...
    description: "Professional vermicomposting kit with worm bin, coco peat, and live red worms to begin vermicomposting.",
    badge: "Eco Pick",
    badgeColor: "bg-primary/10 text-primary",
    buyLink: "https://www.amazon.in/s?k=vermicompost+starter+kit+worm+bin",
  },
  {
    id: 7,
    ...
    badge: null,
    badgeColor: "",
    buyLink: "https://www.amazon.in/s?k=plastic+bottle+crusher+manual",
  },
  {
    id: 8,
    ...
    buyLink: "https://www.amazon.in/s?k=recycling+starter+kit+bundle",
  },
  {
    id: 9,
    ...
    buyLink: "https://www.amazon.in/s?k=reusable+grocery+bag+cotton+set",
  },
];
